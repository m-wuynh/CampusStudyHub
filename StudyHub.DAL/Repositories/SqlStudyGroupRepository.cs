...
using BllGroupChatMessage = StudyHub.BLL.Entities.GroupChatMessage;
using BllStudyGroup = StudyHub.BLL.Entities.StudyGroup;
...
{
    public IReadOnlyList<BllStudyGroup> GetAll()
    {
    ...
    public BllStudyGroup? GetById(string groupId)
    {
    ...
    public BllStudyGroup Add(BllStudyGroup group)
    {
    ...
    public void Update(BllStudyGroup group)
    {
    ...
    private static BllStudyGroup ToDomain(DalStudyGroup group)
    {
        ...
        var messages = group.GroupMembers
            .SelectMany(member => member.GroupPosts
                ...
                .Select(post => new BllGroupChatMessage
                {
